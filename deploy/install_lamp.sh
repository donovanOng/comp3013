...
mysql -h localhost -u root -password=$dbpass < /var/www/comp3013/script/create.sql
mysql -h localhost -u root -password=$dbpass < /var/www/comp3013/script/insert.sql
