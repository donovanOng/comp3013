...
class Collection extends Model
{
  ...
  public function get_friends($collection_userID){
    $sql = "SELECT U.userID
  ...
  public function get_friends_of_friends($collection_userID){
    $sql = "SELECT userID FROM relationship WHERE STATUS=0 AND userID_2=:collection_userID
            UNION 
            SELECT userID_2 FROM relationship WHERE STATUS=0 AND userID=:collection_userID 
            UNION
            SELECT userID FROM relationship where userID != :collection_userID and status=0 and userID_2 in 
                (SELECT userID FROM relationship WHERE STATUS=0 AND userID_2=:collection_userID 
                UNION
                SELECT userID_2 FROM relationship WHERE STATUS=0 AND userID=:collection_userID)
            UNION 
            SELECT userID_2 FROM relationship WHERE userID_2 != :collection_userID and STATUS=0 AND userID in 
                (SELECT userID FROM relationship WHERE STATUS=0 AND userID_2=:collection_userID 
                UNION
                SELECT userID_2 FROM relationship WHERE STATUS=0 AND userID=:collection_userID)";
    $query = $this->db->prepare($sql);
  ...
  public function get_circle_members_access($collectionID){
              ...
              (
                ...
                AND userID IN (
                  ...
                  FROM 
                    ...
                    user U 
                  WHERE 
                    CASE WHEN R.userID = :userID THEN R.userID_2 = U.userID WHEN R.userID_2 = :userID THEN R.userID = U.userID END 
                    AND status = 0
                )
              ) 
              OR (
